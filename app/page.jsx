...
const Home = () => {
  return (
    ...
    و خليها تتعمل
        ...
        انضم إلينا النهارده وشارك معانا نصيحتك عشان تبقى سبب إلهام للناس وتساهم في تحسين حياتهم. ممكن تقرا النصائح، تشارك تجاربك، وتستفيد من حكمة الناس اللي حواليك.
